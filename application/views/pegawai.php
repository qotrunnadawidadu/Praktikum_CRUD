						...
						<nav class="navbar navbar-default" role="navigation">
							<div class="container-fluid">
								...
								<button type="button" class="navbar-toggle" data-toggle="collapse" data-target=".navbar-ex1-collapse">
									...
									<a class="navbar-brand" href="<?php echo site_url('about') ?>">CRUD</a>
								</div>
								...
								<?php foreach ($pegawai_list as $key) { ?>
									<tr>
										...
										<td>
											...
											<a href="<?php echo site_url('pegawai/delete/').$key->id ?>" type="button" class="btn btn-danger" onClick="JavaScript: return confirm('Anda Yakin Ingin Menghapus Data ?')">Delete </a>
